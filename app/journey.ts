...
export const tourFrames:TourFrame[]=[
 {p:0,eye:[-13,12,-17],look:[2.1,4.4,5.2],ceiling:20,chapter:0,title:'Một ngôi nhà. Một hành trình.',description:'Từ không gian sum họp đến khoảng sân đầy nắng. Cuộn để bước vào nhà.',floor:0},
 ...
 {p:1,eye:[-13,13,-17],look:[2.1,4.4,5.2],ceiling:20,chapter:0,title:'Trở lại toàn cảnh',description:'Bạn có thể xem lại hành trình hoặc chuyển sang Tự do để xoay và khám phá.',floor:2}
];
